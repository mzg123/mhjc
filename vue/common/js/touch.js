//cdn.bootcss.com/touchjs/0.2.14/touch.js/*! touchjs v0.2.14  2014-08-05 */
'use strict';
        ...
        pinch: function(ev) {
            ...
            if (config.pinch) {
                ...
                if (Math.abs(1 - scale) > config.minScaleRate) {
                    ...
                    //æ‰‹åŠ¿æ”¾å¤§, è§¦å‘pinchoutäº‹ä»¶
                    var scale_diff = 0.00000000001; //é˜²æ­¢touchendçš„scaleä¸Ž__scale_last_rateç›¸ç­‰ï¼Œä¸è§¦å‘äº‹ä»¶çš„æƒ…å†µã€‚
                    if (scale > __scale_last_rate) {
                        __scale_last_rate = scale - scale_diff;
                        engine.trigger(el, smrEventList.PINCH_OUT, scaleEv, false);
                    } //æ‰‹åŠ¿ç¼©å°,è§¦å‘pinchinäº‹ä»¶
